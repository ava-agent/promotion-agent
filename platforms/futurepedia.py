"""Futurepedia — AI directory submission.

Submits AI tools to the Futurepedia directory. If the site uses
...
@register_platform
class FuturepediaPlatform(BaseHttpPlatform):
    PLATFORM_NAME = "futurepedia"
    ...
    async def health_check(self) -> bool:
        try:
            resp = await self.client.get("https://www.futurepedia.io/")
