"""TAAFT (There's An AI For That) — AI directory submission.

Submits AI tools to the TAAFT directory. If the site uses
...
@register_platform
class TAAFTPlatform(BaseHttpPlatform):
    PLATFORM_NAME = "taaft"
    DISPLAY_NAME = "TAAFT"
        ...
        try:
            ...
            response = await self.client.post(
                ...
                data={
                    ...
                    "tool_url": adapted["url"],
                    "tool_description": adapted["description"],
                    "tool_category": adapted["category"],
                    "tool_pricing": adapted["pricing"],
                },
            )
    ...
    async def health_check(self) -> bool:
        try:
            resp = await self.client.get("https://theresanaiforthat.com/")
